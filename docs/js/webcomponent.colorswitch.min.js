...
this.colors=this.getAttribute('color-map')||[["#123D3C","#90F072"],["#403D58","#dea584"],["#400E3B","#DCC78A"],["#17098D","#EADD1C"],["#233B07","#FFDD6D"],["#37059F","#D1D99F"],["#222","#ccc"]];this.render(this.state);this.addEventListener("click",this.switchColor);document.addEventListener("DOMContentLoaded",()=>{let theme=window.localStorage.getItem(this.LOCAL_STORAGE_KEY);if(theme!=null){let colors=JSON.parse(theme).colors;this.setThemeOnBody(colors);}});}
CSS(){return `<style>
    :host {

...
this.LOCAL_STORAGE_KEY="kgde_theme_dark_mode";this.addEventListener("click",this.changeMode);document.addEventListener("DOMContentLoaded",()=>{let darkModeFromLocalStorage=window.localStorage.getItem(this.LOCAL_STORAGE_KEY);if(darkModeFromLocalStorage!=null){let dm=darkModeFromLocalStorage=="true";this.setDarkMode(dm);}

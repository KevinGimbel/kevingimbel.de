...
This is a level of deep integration I simply cannot get from Hugo, and I'm very excited about it!
...
<details>
<summary>File structure as code block</summary>
<pre><code>
├── 2012
│   └── 10
│       ├── 2012-10-14-selection.md
│       └── 2012-10-14-switching-to-notepad-plus-plus.md
├── 2013
│   ├── 08
│   │   ├── 12-hello-world.md
│   │   ├── 15-px-vs-em.md
│   │   └── 16-is-this-valid.md
│   ├── 09
│   │   ├── 01-endless-scrolling.md
│   │   └── 20-a-bit-sticky.md
│   ├── 10
│   │   ├── 02-from-0-to-sass.md
│   │   ├── 13-join-a-dev-group.md
│   │   ├── 14-i-js.md
│   │   ├── 16-ghost-in-the-shell.md
│   │   └── 28-custom-radio-buttons.md
│   ├── 11
│   │   ├── 18-to-infinity-and-beyond.md
│   │   └── 24-pseudo-product-flags.md
│   └── 12
│       ├── 22-how-i-got-employed.md
│       └── 25-brackets-vs-sublime-text.md
├── 2014
│   ├── 01
│   │   ├── 02-webdev-in-2014.md
│   │   ├── 05-mixtape-2013.md
│   │   ├── 06-bullgit-loves-jekyll.md
│   │   ├── 08-labels-in-gmail.md
│   │   ├── 10-digitalism-boiler-room-at-melt.md
│   │   └── 13-fatboy-slim-why-try-harder.md
│   ├── 02
│   │   └── 22-pure-javascript-slider.md
│   ├── 03
│   │   └── 02-mixtape-february-2014.md
│   ├── 05
│   │   ├── 23-passing-argumets-javascript.md
│   │   ├── 26-vim-first-impressions.md
│   │   └── 27-magento-variables-config-xml.md
│   ├── 06
│   │   └── 13-tools-for-web-developer.md
│   ├── 07
│   │   ├── 13-noobish-vim.md
│   │   ├── 20-a-closer-look-to-closure.md
│   │   └── 31-conditional-css.md
│   ├── 08
│   │   ├── 22-javascript-endless-multi-dimensional-navigation.md
│   │   └── 27-magento-set-get-variables-backend.md
│   └── 11
│       └── 21-snippet-theme-color-android-5-0.md
├── 2015
│   ├── 01
│   │   ├── 21-getting-into-vim-again.md
│   │   └── 22-snippet-source-maps-gulp.md
│   ├── 03
│   │   └── 10-getting-into-performance-measurement.md
│   ├── 05
│   │   └── 07-react-js-tutorial-hello-world.md
│   ├── 08
│   │   └── 13-august-mixtape-drum-and-bass.md
│   └── 12
│       └── 16-speed-up-jekyll-development.md
├── 2016
│   ├── 11
│   │   └── 16-farewell-jekyll-hello-hugo.md
│   └── 12
│       ├── 21-gotcha-dockerignore.md
│       └── 27-goodbye-ubuntu-hello-mac.md
├── 2017
│   ├── 01
│   │   ├── 01-2016-short-review.md
│   │   ├── 08-2017-week-one.md
│   │   ├── 09-cli-tools-node.md
│   │   ├── 12-bash-script-ws.md
│   │   ├── 15-2017-week-two.md
│   │   ├── 17-deploy-a-static-site-with-git.md
│   │   ├── 22-2017-week-three.md
│   │   └── 29-2017-week-four.md
│   ├── 02
│   │   ├── 08-2017-week-five.md
│   │   └── 18-2017-week-seven.md
│   ├── 03
│   │   ├── 05-2017-week-eight-nine.md
│   │   └── 29-using-the-terminal-part-1.md
│   ├── 04
│   │   └── 02-2017-week-10-11-12-13.md
│   └── 11
│       └── 26-a-new-look.md
├── 2018
│   ├── 04
│   │   └── 19-bash-select-options.md
│   └── 09
│       └── 12-hugo-mastodon-embed.md
├── 2020
│   ├── 01
│   │   ├── 02-conditional-calc-css.md
│   │   ├── 03-hugo-add-note-old-articles.md
│   │   ├── 03-ignore-index-files-list.md
│   │   ├── 06-hugo-aliases-redirect.md
│   │   ├── 07-using-archetypes-in-hugo.md
│   │   ├── 08-auto-ssl-with-apache2.md
│   │   ├── 25-2fa-passwords-cloud-sync.md
│   │   └── 29-no-tracking.md
│   ├── 03
│   │   └── 24-random-theme.md
│   ├── 04
│   │   ├── 24-terrasave.md
│   │   ├── 27-night-on-earth.md
│   │   └── 29-selfmade-iced-tea.md
│   ├── 05
│   │   ├── 05-docker-apache-proxy-setup.md
│   │   ├── 14-unreal-engine-five.md
│   │   ├── 18-deno-v1.md
│   │   ├── 19-diy-face-masks
│   │   │   ├── 01_mask_left.jpg
│   │   │   ├── 02_mask_right.jpg
...
│   │   │   ├── mask_blue.jpg
│   │   │   ├── mask_front.jpg
│   │   │   └── mask_left_on_face.jpg
│   │   ├── 20-dan-dubuque-slide-guitarist.md
│   │   ├── 25-hallo-welt.md
│   │   ├── 28-untold-history-arkane.md
│   │   └── 29-berlin-berlin.md
│   ├── 06
│   │   └── 18-corona-warn-app.md
│   ├── 08
│   │   ├── 06-rust-cli-mit-docker-ausliefern.md
│   │   ├── 06-ship-rust-cli-docker.md
│   │   ├── 10-fall-guys
│   │   │   ├── FallGuys_all-running.png
│   │   │   ├── FallGuys_qualified.png
│   │   │   └── index.md
│   │   ├── 16-greg-keyes-the-infernal-city
│   │   │   ├── index.md
│   │   │   └── the-infernal-city.jpg
│   │   └── 17-greg-keyes-lord-of-souls
│   │       ├── index.md
│   │       └── lord-of-souls.jpg
│   ├── 09
│   │   ├── 01-hannah-gadsby-douglas.md
│   │   ├── 13-ich-buk-sauerteig-brot
│   │   │   ├── index.md
│   │   │   └── sauerteig-brot-monster.jpg
│   │   ├── 23-keychron-k2
│   │   │   ├── index.md
│   │   │   ├── keychron-k2-backlight.jpg
│   │   │   └── keychron-k2.jpg
│   │   └── 30-rust-compiler-umgebungsvariablen
│   │       └── index.md
│   ├── 10
│   │   ├── 01-tagliatelle-mit-rote-beete-feta-dill
│   │   │   ├── index.md
│   │   │   └── tagliatelle-mit-rote-beete.jpg
│   │   ├── 12-new-settings
│   │   │   ├── index.md
│   │   │   ├── settings-detail.png
│   │   │   └── settings-on-page.png
│   │   └── 26-ich-buk-saatenbrot
│   │       ├── fertiges-saatenbrot.jpg
│   │       ├── index.md
│   │       └── teigling-im-gaerkorb.jpg
│   ├── 11
│   │   ├── 02-grep-in-action
│   │   │   └── index.md
│   │   └── 30-die-linke-hand-der-dunkelheit
│   │       ├── die-linke-hand-der-dunkelheit-cover.jpg
│   │       └── index.md
│   └── 12
│       ├── 02-make-a-language.md
│       ├── 03-creating-a-snake-clone-in-rust.md
│       └── 04-apply-patch-from-github-pr
│           └── index.md
├── 2021
│   ├── 01
│   │   └── 30-this-week-on-the-internetz
│   │       ├── dogecoin-stonks.png
│   │       └── index.md
│   └── 02
│       └── 09-prometheus-query-wildcard.md
├── _blog.json
</code></pre>
</details>
